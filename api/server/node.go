...
func (h *NodeAPIHandler) New() types.Resource {
	return &types.Node{}
}
...
func (h *NodeAPIHandler) Index() map[string]types.Resource {
	nodes := h.g.GetNodes(nil)
	nodeMap := make(map[string]types.Resource, len(nodes))
...
func (h *NodeAPIHandler) Get(id string) (types.Resource, bool) {
...
func (h *NodeAPIHandler) Decorate(resource types.Resource) {
}

// Create adds the specified node to the graph
func (h *NodeAPIHandler) Create(resource types.Resource, createOpts *CreateOptions) error {
