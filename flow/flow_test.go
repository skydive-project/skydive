			...
			DNS: []*fl.DNS{
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:14.972502+03:00"),
				},
				{
					ID:           26854,
					OpCode:       "Query",
				...
				},
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:14.972525+03:00"),
				},
				{
					ID:           26854,
					QR:           true,
					...
					Authorities: []fl.DNSResourceRecord{
						...
						},
						{
							...
							TTL:        1691,
							DataLength: 6,
							NS:         "n0x.akamaiedge.net",
						},
					},
					Additionals: []fl.DNSResourceRecord{
						{
							Name:       "n0x.akamaiedge.net",
							Type:       "A",
							Class:      "IN",
							TTL:        3833,
							DataLength: 4,
						...
						},
						{
							...
							TTL:        3833,
							DataLength: 16,
							IP:         "2600:1480:e800::c0",
						},
					},
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:14.983675+03:00"),
				},
				{
					ID:           38125,
					QR:           true,
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:14.984235+03:00"),
				},
			},
		},
		{
			...
			DNS: []*fl.DNS{
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:24.608921+03:00"),
				},
				{
					ID:           40590,
					OpCode:       "Query",
				...
				},
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:24.62057+03:00"),
				},
			},
		},
		{
			...
			DNS: []*fl.DNS{
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:32.478347+03:00"),
				},
				{
					ID:           47739,
					OpCode:       "Query",
				...
				},
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:32.478361+03:00"),
				},
				{
					ID:           47739,
					QR:           true,
					...
					Authorities: []fl.DNSResourceRecord{
						...
						},
						{
							...
							TTL:        70989,
							DataLength: 25,
							NS:         "ns-1793.awsdns-32.co.uk",
						},
					},
					Additionals: []fl.DNSResourceRecord{
						{
							Name:       "ns-433.awsdns-54.com",
							Type:       "A",
							Class:      "IN",
							TTL:        106431,
							DataLength: 4,
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:32.488605+03:00"),
				},
				{
					ID:           28799,
					QR:           true,
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:32.546622+03:00"),
				},
			},
		},
		{
			...
			DNS: []*fl.DNS{
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:45.375392+03:00"),
				},
				{
					ID:           27181,
					OpCode:       "Query",
				...
				},
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:45.385335+03:00"),
				},
			},
		},
		{
			...
			DNS: []*fl.DNS{
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:45.327792+03:00"),
				},
				{
					ID:           43789,
					OpCode:       "Query",
				...
				},
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:45.395144+03:00"),
				},
			},
		},
		{
			...
			DNS: []*fl.DNS{
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:45.395506+03:00"),
				},
				{
					ID:           64755,
					OpCode:       "Query",
				...
				},
				{
					...
					Timestamp: timeParse(time.RFC3339Nano, "2019-06-06T06:40:45.40624+03:00"),
				},
			},
		},
	}
...
func compareDNSArrays(expected, tested []*fl.DNS) bool {
	if len(tested) != len(expected) {
		return false
	}
	for _, e := range expected {
...
func compareFlow(expected, tested *Flow) bool {
	...
	if ((expected.DNS == nil || len(expected.DNS) == 0) && (tested.DNS != nil && len(tested.DNS) > 0)) ||
		((expected.DNS != nil && len(expected.DNS) > 0) && (tested.DNS == nil || len(tested.DNS) == 0)) {
		return false
	}
	if expected.DNS != nil && len(expected.DNS) > 0 && !compareDNSArrays(expected.DNS, tested.DNS) {
		return false
	}
...
func timeParse(layout, s string) time.Time {
