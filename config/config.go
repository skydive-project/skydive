...
func init() {
	...
	cfg.SetDefault("storage.elasticsearch.bulk_topology_update", 1)
	cfg.SetDefault("storage.elasticsearch.bulk_topology_update_max", 100)
	cfg.SetDefault("storage.elasticsearch.topology_update_timer", 5)
