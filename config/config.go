...
func init() {
	...
	cfg.SetDefault("analyzer.storage.index_entries_limit", -1)
	cfg.SetDefault("analyzer.storage.index_age_limit", -1)
	cfg.SetDefault("analyzer.storage.indices_to_keep", -1)
	...
	cfg.SetDefault("storage.elasticsearch.index_entries_limit", -1)
	cfg.SetDefault("storage.elasticsearch.index_age_limit", -1)
	cfg.SetDefault("storage.elasticsearch.indices_to_keep", -1)
