...
.PHONY: functional
functional:
	$(MAKE) test.functionals VERBOSE=true TIMEOUT=10m ARGS='-standalone -analyzer.storage.topology.backend elasticsearch -analyzer.storage.flow.backend elasticsearch'
