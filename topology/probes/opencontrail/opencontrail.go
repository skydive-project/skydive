...
func NewOpenContrailProbeFromConfig(g *graph.Graph, r *graph.Node) (*OpenContrailProbe, error) {
	...
	return &OpenContrailProbe{
		...
		graph:                   g,
		root:                    r,
		agentHost:               config.GetString("agent.topology.opencontrail.host"),
		agentPort:               config.GetInt("agent.topology.opencontrail.port"),
		mplsUDPPort:             config.GetInt("agent.topology.opencontrail.mpls_udp_port"),
