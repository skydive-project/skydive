...
func easyjsonD70da1b5DecodeGithubComSkydiveProjectSkydiveTopologyProbesOvnOvnmodel(in *jlexer.Lexer, out *GatewayChassis) {
...
func easyjsonD70da1b5EncodeGithubComSkydiveProjectSkydiveTopologyProbesOvnOvnmodel(out *jwriter.Writer, in GatewayChassis) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UUID != "" {
...
func (v GatewayChassis) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD70da1b5EncodeGithubComSkydiveProjectSkydiveTopologyProbesOvnOvnmodel(&w, v)
...
func (v *GatewayChassis) UnmarshalJSON(data []byte) error {
	...
	easyjsonD70da1b5DecodeGithubComSkydiveProjectSkydiveTopologyProbesOvnOvnmodel(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GatewayChassis) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD70da1b5DecodeGithubComSkydiveProjectSkydiveTopologyProbesOvnOvnmodel(l, v)
}
