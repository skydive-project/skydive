...
func NewRuntime(assets assets.Assets) (*Runtime, error) {
	...
	if err := r.runEmbededScript("promise-7.0.4.min.js"); err != nil {
		return nil, err
	}

	if err := r.runEmbededScript("promise-done-7.0.4.min.js"); err != nil {
		return nil, err
	}

	if err := r.runEmbededScript("api.js"); err != nil {
		return nil, err
	}
